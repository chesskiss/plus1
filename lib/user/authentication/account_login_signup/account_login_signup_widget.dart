...
class AccountLoginSignupWidget extends StatefulWidget {
  ...
  State<AccountLoginSignupWidget> createState() =>
      _AccountLoginSignupWidgetState();
}

class _AccountLoginSignupWidgetState extends State<AccountLoginSignupWidget>
    with TickerProviderStateMixin {
  late AccountLoginSignupModel _model;
  ...
  void initState() {
    ...
    _model.signPasswordConfirmTextController ??= TextEditingController();
    _model.signPasswordConfirmFocusNode ??= FocusNode();

    _model.logEmailAddressTextController ??= TextEditingController();
                                            ...
                                            decoration: InputDecoration(
                                              ...
                                              suffixIcon: InkWell(
                                                ...
                                                focusNode: FocusNode(
                                                    skipTraversal: true),
                                                child: Icon(
                                                  _model.signPasswordConfirmVisibility
                                                      ? Icons
                                                          .visibility_outlined
                                                      : Icons
                                                          .visibility_off_outlined,
