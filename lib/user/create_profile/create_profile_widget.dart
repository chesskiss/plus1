...
class _CreateProfileWidgetState extends State<CreateProfileWidget> {
  ...
  void initState() {
    ...
    _model.relationTypeInTextController ??= TextEditingController();
    _model.relationTypeInFocusNode ??= FocusNode();
    _model.relationTypeInFocusNode!.addListener(() => safeSetState(() {}));
    ...
    _model.heightTextController1 ??= TextEditingController(text: 'ft');
    _model.heightFocusNode1 ??= FocusNode();
    _model.heightFocusNode1!.addListener(() => safeSetState(() {}));
    _model.heightTextController2 ??= TextEditingController(text: 'inch');
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    controller:
                                        _model.relationTypeInTextController,
                                    focusNode: _model.relationTypeInFocusNode,
                                    autofocus: true,
                                    textCapitalization:
                                        TextCapitalization.words,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelText: 'Relationship preference*',
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .labelLarge
                                          .override(
                                            fontFamily: 'Figtree',
                                      ...
                                      filled: true,
                                      fillColor: (_model.relationTypeInFocusNode
                                                  ?.hasFocus ??
                                              false)
                                          ? FlutterFlowTheme.of(context).accent1
                                          : FlutterFlowTheme.of(context)
                                  ...
                                  TextFormField(
                                    ...
                                    validator: _model
                                        ...
                                        .asValidator(context),
                                    inputFormatters: [_model.genderMask],
                                  ),
                                  TextFormField(
                                    controller:
                                        _model.preferencesTextController,
                                    ...
                                    validator: _model
                                        ...
                                        .asValidator(context),
                                    inputFormatters: [_model.preferencesMask],
                                  ),
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      filled: true,
                                      fillColor: (_model.educationFocusNode
                                                  ?.hasFocus ??
                                              false)
                                          ? FlutterFlowTheme.of(context).accent1
                                          : FlutterFlowTheme.of(context)
                                    ...
                                    validator: _model
                                        ...
                                        .asValidator(context),
                                    inputFormatters: [_model.educationMask],
                                  ),
                                  Row(
                                    mainAxisSize: MainAxisSize.max,
                                    children: [
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      filled: true,
                                      fillColor: (_model.descriptionFocusNode1
                                                  ?.hasFocus ??
                                              false)
                                          ? FlutterFlowTheme.of(context).accent1
                                          : FlutterFlowTheme.of(context)
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      filled: true,
                                      fillColor: (_model.descriptionFocusNode2
                                                  ?.hasFocus ??
                                              false)
                                          ? FlutterFlowTheme.of(context).accent1
                                          : FlutterFlowTheme.of(context)
                      ...
                      onPressed: () async {
                        ...
                        await currentUserReference!.update({
                          ...createUserRecordData(
                            ...
                            photoUrl: _model.imageUploadModel.images.first,
                            shortDescription:
                                _model.descriptionTextController1.text,
                            education: _model.educationTextController.text,
                            gender: _model.genderTextController.text,
                            height: createHeightStruct(
                              ft: int.tryParse(
                                  _model.heightTextController1.text),
                              inch: int.tryParse(
                                  _model.heightTextController2.text),
                              clearUnsetFields: false,
                            ),
                            age: int.tryParse(_model.ageTextController.text),
                            iLike: _model.descriptionTextController2.text,
                          ),
                          ...mapToFirestore(
                            {
                              'photos': _model.imageUploadModel.images,
                            },
                          ),
                        });
                        // goBack
