...
class _CreateProfileWidgetState extends State<CreateProfileWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      logFirebaseEvent('createProfile_update_app_state');
      FFAppState().walkthrough = true;
    });
                          ...
                          child: Column(
                            ...
                            children: [
                                  ...
                                  child: AuthUserStreamWidget(
                                    builder: (context) => wrapWithModel(
                                      ...
                                      child: ImagesUploadWidget(
                                        alreadyUploaded: (currentUserDocument
                                                ?.photos
                                                .toList() ??
                                            []),
                                      ),
                              ...
                              TextFormField(
                                ...
                                obscureText: false,
                                decoration: InputDecoration(
                                  labelText: 'Gender (put whatever you want)',
                                  labelStyle: FlutterFlowTheme.of(context)
                                      .labelLarge
                                      .override(
                                        fontFamily: 'Figtree',
                                  ...
                                  filled: true,
                                  fillColor:
                                      (_model.genderFocusNode?.hasFocus ??
                                              false)
                                          ? FlutterFlowTheme.of(context).accent1
                                          : FlutterFlowTheme.of(context)
                                              .secondaryBackground,
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  filled: true,
                                  fillColor:
                                      (_model.preferencesFocusNode?.hasFocus ??
                                              false)
                                          ? FlutterFlowTheme.of(context).accent1
                                          : FlutterFlowTheme.of(context)
                                              .secondaryBackground,
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  filled: true,
                                  fillColor:
                                      (_model.educationFocusNode?.hasFocus ??
                                              false)
                                          ? FlutterFlowTheme.of(context).accent1
                                          : FlutterFlowTheme.of(context)
                                              .secondaryBackground,
                              ...
                              Row(
                                ...
                                children: [
                                  Expanded(
                                    child: TextFormField(
                                      controller: _model.heightTextController1,
                                  ...
                                  Expanded(
                                    child: TextFormField(
                                      controller: _model.heightTextController2,
                                ...
                                decoration: InputDecoration(
                                  ...
                                  contentPadding:
                                      EdgeInsetsDirectional.fromSTEB(
                                          16.0, 16.0, 16.0, 16.0),
                                  suffixIcon: _model
                                          .iLikeTextController!.text.isNotEmpty
                                      ? InkWell(
                                          onTap: () async {
                                            _model.iLikeTextController?.clear();
                                            safeSetState(() {});
                                          },
                                          child: Icon(
                                            Icons.clear,
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'CREATE_PROFILE_PAGE_READY_BTN_ON_TAP');
                              ...
                              if (_model.imagesUploadModel.uploadedImages
                                      .length >=
                                  1) {
                                logFirebaseEvent('Button_custom_action');
                                _model.relationsEnum =
                                    await actions.relations2Enums(
                                  _model.relationTypeValue?.toList(),
                                );
                                _shouldSetState = true;
                                // EditProfile
                                logFirebaseEvent('Button_EditProfile');

                                await currentUserReference!.update({
                                  ...createUserRecordData(
                                    preferences:
                                        _model.preferencesTextController.text,
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      ...
                                      content: Text(
                                          'Please upload at least 1 profile image'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
