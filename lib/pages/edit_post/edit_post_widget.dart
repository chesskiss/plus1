  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      await Future.wait([
        Future(() async {
          // Enums2Activity
          _model.activityStrings = actions.enums2activityType(
            widget.post?.activityType.toList(),
          );
        }),
        Future(() async {
          // Enums2Exclusivty
          _model.exclusivityStrings = actions.enums2exclusivity(
            widget.post?.exclusivityType.toList(),
          );
        }),
        Future(() async {
          // DressCode2Strings
          _model.dressCodeStrings = actions.enums2dressCode(
                          ...
                          children: [
                            Expanded(
                              child: SwitchListTile.adaptive(
                                value: _model.sponsorshipTileValue ??=
                                    widget.post!.sponsored,
                                onChanged: (newValue) async {
                                  safeSetState(() =>
                                      _model.sponsorshipTileValue = newValue);
                                },
                                title: Text(
                                  'Do you have the required access to the event?',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyLarge
                                      .override(
                                        fontFamily: 'Figtree',
                      ...
                      onPressed: () async {
                        ...
                        await widget.post!.reference.update({
                          ...createPostRecordData(
                            ...
                            sponsored: _model.sponsorshipTileValue,
