                          ...
                          children: [
                            Container(
                              ...
                              child: wrapWithModel(
                                ...
                                child: ImageUploadWidget(
                                  setImages: editPostPostRecord.photos,
                                ),
                              ),
                            ),
                            TextFormField(
                            ...
                            TextFormField(
                              controller: _model.descriptionTextController ??=
                                  TextEditingController(
                                text: editPostPostRecord.description,
                              ),
                                ...
                                Expanded(
                                  child: FlutterFlowChoiceChips(
                                    ...
                                    controller:
                                      ...
                                      functions.enum2exclusivity(
                                          editPostPostRecord.exclusivityType
                                              .toList()),
                                    ),
                                    wrapped: true,
                                  ),
                                ...
                                Expanded(
                                  child: SwitchListTile.adaptive(
                                    value: _model.sponsorshipTileValue ??=
                                        editPostPostRecord.sponsored,
                                    onChanged: (newValue) async {
                                      setState(() => _model
                                          .sponsorshipTileValue = newValue);
                                    },
                                    title: Text(
                                  ...
                                  child: FlutterFlowChoiceChips(
                                    ...
                                    controller:
                                        _model.activityTypeCcValueController ??=
                                            FormFieldController<List<String>>(
                                      functions.enum2activityType(
                                          editPostPostRecord.activityType
                                              .toList()),
                                    ),
                                    wrapped: true,
                                  ),
                          ...
                          onPressed: () async {
                            ...
                            await widget.post!.update({
                              ...createPostRecordData(
                                title: editPostPostRecord.title,
                                description:
