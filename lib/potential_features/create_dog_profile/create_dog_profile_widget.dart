...
class CreateDogProfileWidget extends StatefulWidget {
  ...
  static String routeName = 'createDogProfile';
  static String routePath = '/createDogProfile';
      ...
      appBar: AppBar(
        ...
        actions: [
          FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('CREATE_DOG_PROFILE_close_rounded_ICN_ON_');
          ...
          children: [
              ...
              children: [
                ...
                Container(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent(
                          'CREATE_DOG_PROFILE_Image_m236q23v_ON_TAP');
            ...
            Padding(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('CREATE_DOG_PROFILE_ADD_PUP_BTN_ON_TAP');
