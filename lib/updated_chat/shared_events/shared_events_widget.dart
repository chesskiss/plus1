                                ...
                                child: StreamBuilder<List<PostRecord>>(
                                  stream: queryPostRecord(
                                    queryBuilder: (postRecord) =>
                                        postRecord.whereIn('op', widget.users),
                                  ),
                                              ...
                                              children: [
                                                                        ...
                                                                        return GestureDetector(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              postParam: socialFeedPostRecord.reference,
                                                                            ),
                                                                          ),
                                                                        );
                                                                      },
                                                ...
                                                Align(
                                                  ...
                                                  child: PostImagesWidget(
                                                    key: Key(
                                                        'Key8vn_${socialFeedIndex}_of_${socialFeedPostRecordList.length}'),
                                                    postImages:
                                                        socialFeedPostRecord
                                                            .photos,
                                                  ),
                                                ...
                                                SocialIconsWidget(
                                                  key: Key(
                                                      'Key2jy_${socialFeedIndex}_of_${socialFeedPostRecordList.length}'),
                                                  post: socialFeedPostRecord
                                                      .reference,
                                                ),
                                                ExclusivityMainfeedRowWidget(
                                                  key: Key(
                                                      'Keyv81_${socialFeedIndex}_of_${socialFeedPostRecordList.length}'),
                                                  exclusivityType:
                                                      socialFeedPostRecord
                                                          .exclusivityType,
                                                ),
