...
import 'chat2_details_real_model.dart';
export 'chat2_details_real_model.dart';

class Chat2DetailsRealWidget extends StatefulWidget {
  const Chat2DetailsRealWidget({
    super.key,
  ...
  @override
  State<Chat2DetailsRealWidget> createState() => _Chat2DetailsRealWidgetState();
}

class _Chat2DetailsRealWidgetState extends State<Chat2DetailsRealWidget> {
  late Chat2DetailsRealModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Chat2DetailsRealModel());
                              ...
                              context.pushNamed(
                                ...
                                queryParameters: {
                                  'profile': serializeParam(
                                    conditionalBuilderUserRecord.reference,
