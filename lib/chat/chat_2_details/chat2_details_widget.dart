...
import '/feedback/rate_event/rate_event_widget.dart';
                ...
                builder: (context) {
                  if (widget.chatRef!.users.length <= 2) {
                    return Row(
                      ...
                      children: [
                        if (conditionalBuilderUserRecord.photos.firstOrNull !=
                                null &&
                            conditionalBuilderUserRecord.photos.firstOrNull !=
                                '')
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'CHAT_2_DETAILS_Container_os0daalc_ON_TAP');
                        ...
                        Expanded(
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'CHAT_2_DETAILS_Column_1myfh8ar_ON_TAP');
                              // ChatDetailsModal
                              logFirebaseEvent('Column_ChatDetailsModal');
                        ...
                        Builder(
                          builder: (context) => InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'CHAT_2_DETAILS_Container_jopjfwm2_ON_TAP');
                                  ...
                                  return Dialog(
                                    ...
                                    child: GestureDetector(
                                      ...
                                      child: Container(
                                        ...
                                        child: RateEventWidget(
                                          user: conditionalBuilderUserRecord,
                                        ),
                                      ),
                                    ),
                                  );
                      ...
                      children: [
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'CHAT_2_DETAILS_Stack_hkhn3mi8_ON_TAP');
                                  ...
                                  Align(
                                    ...
                                    child: StreamBuilder<UserRecord>(
                                      stream: UserRecord.getDocument(
                                          widget.chatRef!.users.lastOrNull!),
                                      builder: (context, snapshot) {
                                        // Customize what your widget looks like when it's loading.
                                        if (!snapshot.hasData) {
                                          return Center(
                        ...
                        Expanded(
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'CHAT_2_DETAILS_Column_e6hne4v2_ON_TAP');
                              // ChatDetailsModal
                              logFirebaseEvent('Column_ChatDetailsModal');
                              await showModalBottomSheet(
                                isScrollControlled: true,
          ...
          actions: [
            Padding(
              ...
              child: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('CHAT_2_DETAILS_PAGE_event_ICN_ON_TAP');
                  logFirebaseEvent('IconButton_navigate_to');

                  context.pushNamed(
                    SharedEventsWidget.routeName,
                    queryParameters: {
